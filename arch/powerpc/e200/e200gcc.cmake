...
SET(TOOLCHAIN_DIR $ENV{E200GCC_DIR})
STRING(REGEX REPLACE "\\\\" "/" TOOLCHAIN_DIR "${TOOLCHAIN_DIR}")

IF(NOT TOOLCHAIN_DIR)
    MESSAGE(FATAL_ERROR "***Please set E200GCC_DIR in envionment variables***")
ENDIF()

MESSAGE(STATUS "TOOLCHAIN_DIR: " ${TOOLCHAIN_DIR})

#SET sysroot
#SET(SYSROOT ${TOOLCHAIN_DIR}/../ppce500v1-fsl-linux)

# TARGET_TRIPLET
SET(TARGET_TRIPLET "powerpc-eabivle")


SET(TOOLCHAIN_BIN_DIR ${TOOLCHAIN_DIR}/bin)
SET(TOOLCHAIN_INC_DIR ${TOOLCHAIN_DIR}/include)
SET(TOOLCHAIN_LIB_DIR ${TOOLCHAIN_DIR}/lib/gcc/powerpc-eabivle/4.9.4/e200z7)
