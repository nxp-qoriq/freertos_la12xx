...
#define FLASH_NUM				1
#define BUFFER_RW_SIZE  		0x40

#define FSPI_READ_SEQ_ID 	0
#define FSPI_WREN_SEQ_ID 	1
#define FSPI_WRITE_SEQ_ID	2
#define FSPI_SE_SEQ_ID		3
#define FSPI_RDSR_SEQ_ID	4
#define FSPI_BE_SEQ_ID		5
#define FSPI_FASTREAD_SEQ_ID 	6
#define FSPI_DTR_QUAD_READ_SEQ_ID 7

/* Set ADATSZ with the maximum AHB buffer size in 8 bytes (512 Bytes) */
#define BUFFER_MAX_AHB_SIZE		0x100
#define FLEXSPICR1_CLK_DIV_3	0x3
...
#define FSPI_NOR_CMD_DTR_QUAD_READ  0xED
...
#define FSPI_LUT_CADDR_SDR          0x03
#define FSPI_LUT_MODE               0x04
#define FSPI_LUT_MODE2              0x05
#define FSPI_LUT_MODE4              0x06
#define FSPI_LUT_MODE8              0x07
#define FSPI_LUT_NXP_WRITE          0x08
#define FSPI_LUT_NXP_READ           0x09
#define FSPI_LUT_LEARN_SDR          0x0A
#define FSPI_LUT_DATSZ_SDR          0x0B
#define FSPI_LUT_DUMMY              0x0C
#define FSPI_LUT_DUMMY_RWDS_SDR     0x0D
#define FSPI_LUT_JMP_ON_CS          0x1F
#define FSPI_LUT_CMD_DDR            0x21
#define FSPI_LUT_ADDR_DDR           0x22
#define FSPI_LUT_CADDR_DDR          0x23
#define FSPI_LUT_MODE_DDR           0x24
#define FSPI_LUT_MODE2_DDR          0x25
#define FSPI_LUT_MODE4_DDR          0x26
#define FSPI_LUT_MODE8_DDR          0x27
#define FSPI_LUT_WRITE_DDR          0x28
#define FSPI_LUT_READ_DDR           0x29
#define FSPI_LUT_LEARN_DDR          0x2A
#define FSPI_LUT_DATSZ_DDR          0x2B
#define FSPI_LUT_DUMMY_DDR          0x2C
#define FSPI_LUT_DUMMY_RWDS_DDR     0x2D
...
#define FSPI_FLSHXCR1_TCSH_DEFAULT		3
#define FSPI_FLSHXCR1_TCSS_DEFAULT		3
