...
//#define DBG_DUMP_QDMA
//#define DBG_DUMP_CMDS
...
bool l1c_vspa_configured_fr1()
{
	...
	if ((config_common.interfaces[0].in_use && config_common.interfaces[0].interface_id < 4) ||
		...
		(config_common.interfaces[2].in_use && config_common.interfaces[2].interface_id < 4) ||
		(config_common.interfaces[3].in_use && config_common.interfaces[3].interface_id < 4))
		return true;
