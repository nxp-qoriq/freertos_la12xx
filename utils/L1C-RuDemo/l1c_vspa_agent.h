...
typedef enum {
	SIGNAL_SAMPLE_RATE_122 = 0,  /*  122.88 Msps */
	SIGNAL_SAMPLE_RATE_245 = 1,  /*  245.76 Msps */
	SIGNAL_SAMPLE_RATE_491 = 2,  /*  491.52 Msps */
	SIGNAL_SAMPLE_RATE_983 = 3,  /*  983.04 Msps */
	SIGNAL_SAMPLE_RATE_1966 = 4, /* 1966.08 Msps */
} signal_config_sample_rate_e;

static inline uint32_t sample_rate_enum2Hz(signal_config_sample_rate_e efs)
{
	uint32_t f_s;
...
static inline signal_config_sample_rate_e sample_rate_str2enum(const char *c)
{
	if (!c)
		return 0;
	...
	switch(c[0]) {
		case '1':
			return (c[1] == '9') ? SIGNAL_SAMPLE_RATE_1966 : SIGNAL_SAMPLE_RATE_122; 
		case '2': return SIGNAL_SAMPLE_RATE_245;
		case '4': return SIGNAL_SAMPLE_RATE_491;
		case '9': return SIGNAL_SAMPLE_RATE_983;
	}

	return 0;
}

static inline char * sample_rate_enum2str(signal_config_sample_rate_e e)
{
	switch(e) {
		case SIGNAL_SAMPLE_RATE_1966: return "1966.08 Msps";
		case SIGNAL_SAMPLE_RATE_983: return  " 983.04 Msps";
		case SIGNAL_SAMPLE_RATE_491: return  " 491.52 Msps";
		case SIGNAL_SAMPLE_RATE_245: return  " 245.76 Msps";
		case SIGNAL_SAMPLE_RATE_122: return  " 122.88 Msps";
	}
...
typedef struct {
	...
	uint32_t dpd_sample_rate;        /* 245.76 MHz or 491.52 MHz */
} signal_config_t;
...
typedef struct {
	int32_t f_nco;
	signal_config_sample_rate_e f_s;
