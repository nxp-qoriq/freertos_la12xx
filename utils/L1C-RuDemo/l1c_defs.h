...
#define TBGEN_1_US         TBGEN1_REF_CLK
#define TBGEN_25_US        (6144)
#define TBGEN_50_US        (2*TBGEN_25_US)
...
#define MAX_USED_INTERFACES		4 /* 4T4R */
#define MAX_OBS_IF			2
...
typedef struct {
	...
	l1c_obs_if_t obs_if[MAX_OBS_IF];
	uint32_t tdd_ul_dl_gap;    /* nS */
	bool_t tdd_control_for_rf_card;
	int limited_slot_no;
...
typedef enum {
	...
	L1C_CONFIG_INTERFACE1,
	L1C_CONFIG_INTERFACE2,
	L1C_CONFIG_INTERFACE3,
	L1C_CONFIG_OBS_IF,
	L1C_CONFIG_OBS_IF1,
...
typedef struct {
	...
	union {
		...
		l1c_config_obs_if_t cfg_obs_if;
		bool_t rx_always_listen;
		bool_t rf_fem_ctrl;
		uint32_t tdd_ul_dl_gap;
		int pps_offset;
		tdd_scs_t scs;
...
extern modem_mode_e modem_mode;
#endif /* __L1C_DEFS_H */
