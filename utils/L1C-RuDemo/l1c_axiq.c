...
vuint32 * l1c_get_lp_ctrl(uint8_t interface)
{
	vuint32 * puTimerCtrl;
	uint8_t ucTbgenNo, dcs;
	...
	{
		ucTbgenNo = TBGEN_1;
		puTimerCtrl = ( vuint32 * ) ( TBGEN_BASE( ucTbgenNo ) + uTimerCtrlOffset[TDD] + (TDD_TIMER_BLOCK_SIZE * (interface + 4) ));
...
void l1c_lp_timer_program(vuint32 * timer,
