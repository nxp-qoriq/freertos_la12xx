...
#if defined(GEUL_LA1238RDB) || defined (GEUL_LA1224)
#undef NO_RF
#else
/* define NO_RF to prevent RefApp from controlling RF FEM signals on unknown boards*/
#define NO_RF
#endif
...
#define UL_DL_GAP_DEFAULT_VALUE   2000
