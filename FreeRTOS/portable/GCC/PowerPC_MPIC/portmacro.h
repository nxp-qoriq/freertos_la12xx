...
#define portMPIC_CTPR0()  (*(volatile unsigned int *)(MPIC_REGS_CTPR0))
#define portMPIC_CTPR0_RD()     mpic_in32(MPIC_REGS_CTPR0)
#define portMPIC_CTPR0_WR(val)  mpic_out32(MPIC_REGS_CTPR0, (val))
/*-----------------------------------------------------------*/
...
static BaseType_t msr;
static portFORCE_INLINE UBaseType_t portGET_CRITICAL_NESTING( void )
{
...
static portFORCE_INLINE void vPortMaskInterrupts( void )
{
    ...
    //portMPIC_CTPR0() = configMAX_API_CALL_INTERRUPT_PRIORITY;
    portMPIC_CTPR0_WR(configMAX_API_CALL_INTERRUPT_PRIORITY);
...
{
    //UBaseType_t originalPriority = portMPIC_CTPR0();
#ifdef configMAX_API_CALL_INTERRUPT_PRIORITY
	UBaseType_t originalPriority = portMPIC_CTPR0_RD();
#else
...
static portFORCE_INLINE void vPortUnmaskInterrupts( UBaseType_t priority )
{
    ...
    //portMPIC_CTPR0() = priority;
    portMPIC_CTPR0_WR(priority);
